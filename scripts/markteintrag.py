...
def main() -> int:
    ...
    # Markerzeilen um den Block. Drei Gruende, alle praktisch:
    #
    #   - marktpatch.sh findet ihn damit exakt wieder und ERSETZT ihn bei
    #     einem Versionssprung, statt einen zweiten move-Eintrag anzuhaengen.
    #     Zwei Eintraege mit demselben Namen waeren zwei Kacheln.
    #   - Ein Textmarker braucht keinen TS-Parser. Klammern zaehlen ginge
    #     schief, sobald eine Beschreibung eine unpaarige Klammer enthaelt.
    #   - _apps.ts traegt in Zeile 1 "Generated by gen_market.py". Der Marker
    #     sagt dem naechsten Generatorlauf und dem naechsten Leser, woher
    #     dieser Block kommt und dass er nicht von Hand gepflegt wird.
    anfang = f"  // {meta['name']}: erzeugt von scripts/markteintrag.py im Repo {spec['sourceCode']}"
    ende = f"  // {meta['name']}: Ende"
